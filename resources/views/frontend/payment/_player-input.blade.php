<div class="row row-cols-1 row-cols-md-2">
  <div class="col-12 col-lg-4">
    <div class="input-form__player input-group input-group mb-3">
      {{-- <input type="text" class="form-control" aria-label="Id player input" aria-describedby="inputGroup-sizing-sm" placeholder="ID User" name="id-player"> --}}
      {{-- <button type="button" class="input-group-text" id="btnCheckId">Check</button>
      <button type="button" class="input-group-text" id="buttonClear">Clear</button> --}}
    </div>
  </div>
  <div class="col-12 col-lg-4">
